        ...
        <div class="container mx-auto my-[48px]">
            <div class="flex justify-between">
                <div class="w-[144px] h-[30px] overflow-hidden">
                    <img src="{{ asset('assets/images/logo-carilomba.png') }}" alt="" srcset="object-cover object-center" loading="lazy" />
                </div>
                ...
                <div class="ml-0 grid grid-cols-2 gap-[16px]">
                    <div class="w-[35px] h-[35px] bg-[#E18F14] pl-[7px] py-[3px] rounded-md shadow-md">
                        <i class="fa-brands fa-x-twitter text-xl text-white"></i>
                    </div>
                    <div class="w-[35px] h-[35px] bg-[#E18F14] pl-[9px] py-[3px] rounded-md shadow-md">
