...
use App\Filament\Admin\Resources\RequestLombaResource\Pages;
use App\Filament\Admin\Resources\RequestLombaResource\RelationManagers;
...
class RequestLombaResource extends Resource
{
    ...
    {
        return $table
            ->emptyStateHeading('Belum ada request lomba')
            ->columns([
